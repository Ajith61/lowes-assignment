package com.lowes.orderservice.util.constants;
...
public enum ApplicationStatus {
	...
	UPDATED_SUCESS(204, "No Stock"), 
	NO_STOCK(205, "Updated Sucessfully"), 
	CREATED(201, "Created"),
	...
	private ApplicationStatus(String statusMesssage) {
		this.statusMesssage = statusMesssage;
	}
